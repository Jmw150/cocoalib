...
namespace CoCoA
{
  ...
  matrix PartialRingHom::operator()(ConstMatrixView M) const
  {
    ...
    RingElem ans(codomain(*this));
    matrix NewM(NewDenseMat(codomain(*this), NumRows(M), NumCols(M)));
...
// RCS header/log
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/RingHom.C,v 1.18 2022/02/18 14:11:57 abbott Exp $
// $Log: RingHom.C,v $
